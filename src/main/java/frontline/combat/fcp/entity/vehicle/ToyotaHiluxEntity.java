...
public class ToyotaHiluxEntity extends CamoVehicleBase{
    ...
    private static final EntityDataAccessor<Float> STEERING_ANGLE = SynchedEntityData.defineId(ToyotaHiluxEntity.class, EntityDataSerializers.FLOAT);
    ...
    public ToyotaHiluxEntity(EntityType<ToyotaHiluxEntity> type, Level world) {super(type, world);}
