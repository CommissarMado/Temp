package frontline.combat.fcp.entity.vehicle.T64;
...
public class T64Entity extends CamoVehicleBase {

    private static final ResourceLocation[] CAMO_TEXTURES = {
            new ResourceLocation("fcp", "textures/entity/t64/t64.png")
    };

    private static final String[] CAMO_NAMES = {"Base"};

    private static final EntityDataAccessor<Float> STEERING_ANGLE = SynchedEntityData.defineId(T64Entity.class, EntityDataSerializers.FLOAT);
    ...
    public T64Entity(EntityType<T64Entity> type, Level world) {super(type, world);}
